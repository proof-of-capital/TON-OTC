...
const TRANSFER_AMOUNT = toNano('0.000055'); // Amount of tokens to transfer (100 tokens)
const RECIPIENT_ADDRESS = Address.parse('EQDoTNbMCsJxBbun08PPTRoQTLun3XM4uxeGUt0i-jJDdSUq'); // Recipient address (placeholder)
