...
export async function run(provider: NetworkProvider) {
    ...
    console.log('✅ Starting client vote (YES)...');
    ...
    // Send client vote YES transaction
    await otc.send(
        provider.sender(),
        {
    ...
    console.log('📤 Client vote (YES) transaction sent');
    console.log('✅ Client vote completed!');
    console.log('Client has accepted the farm account proposal');
}
